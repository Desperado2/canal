...
export function canalInstanceDetail(id) {
  return request({
    url: '/canal/consumer/instance/' + id,
    method: 'get'
  })
}
...
export function startInstance(id, nodeId) {
  return request({
    url: '/canal/consumer/instance/start/' + id + '/' + nodeId,
    method: 'put'
  })
}
...
export function stopInstance(id, nodeId) {
  return request({
    url: '/canal/consumer/instance/stop/' + id + '/' + nodeId,
    method: 'put'
  })
}
...
export function instanceLog(id, nodeId) {
  return request({
    url: '/canal/consumer/instance/log/' + id + '/' + nodeId,
    method: 'get'
  })
}
...
export function instanceStatus(id, option) {
  return request({
    url: '/canal/consumer/instance/status/' + id + '?option=' + option,
    method: 'put'
  })
}
...
export function getActiveInstances(serverId) {
  return request({
    url: '/canal/consumer/active/instances/' + serverId,
    method: 'get'
  })
}
...
export function getTemplateInstance() {
  return request({
    url: '/canal/consumer/instance/template',
    method: 'get'
  })
}
