...
<script>
import { addNodeServer, getNodeServers, updateNodeServer, deleteNodeServer } from '@/api/consumerNodeServer'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        port: [{ required: true, message: 'Server 端口不能为空', trigger: 'change' }]
      },
      dialogStatus: 'create'
    }
  },
